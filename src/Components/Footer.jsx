...
function Footer() {
  return (
    <div style={{width:'100%',height:'250px',marginTop:'100px',color:'white'}} className='d-flex flex-column justify-content-center align-items-center bg-primary'>
        <div className='footer-div d-flex justify-content-evenly w-100 flex-wrap'>
          ...
          <div className="links d-flex flex-column ">
            ...
            <Link to={'/cart'} style={{ textDecoration:'none', color:'white' }}></Link>
            <Link to={'/watchlist'} style={{ textDecoration:'none', color:'white' }}>Watch History</Link>
          </div>
